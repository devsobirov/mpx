...
return [
    ...
    */
    ...
    'route_path' => \App\Providers\RouteServiceProvider::HOME.'/log-journal',
    ...
    */
    ...
    'back_to_system_url' => \App\Providers\RouteServiceProvider::HOME,
    ...
    */
    ...
    'middleware' => [
        'web',
        'checkRole:'. \App\Helpers\RoleHelper::ROLE_ADMIN,
